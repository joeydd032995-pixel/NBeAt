  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
        ...
        {teams.map((team) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-2xl font-bold text-primary">{team.teamAbbreviation}</h3>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-secondary">{team.offensiveRating}</span>
              </div>

              {/* Defensive Rating */}
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Defensive Rating</span>
                <span className="text-lg font-bold text-primary">{team.defensiveRating}</span>
              </div>

              {/* Pace */}
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Pace</span>
                <span className="text-lg font-bold text-accent">{team.pace}</span>
              </div>
      ...
      <Card className="bg-card border-secondary/30 p-6">
        <h3 className="text-lg font-bold text-primary mb-4">Understanding the Metrics</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            <p className="font-bold text-secondary">Offensive Rating</p>
            <p className="text-muted-foreground">Points scored per 100 possessions. Higher is better.</p>
          </div>
          <div>
            <p className="font-bold text-primary">Defensive Rating</p>
            <p className="text-muted-foreground">Points allowed per 100 possessions. Lower is better.</p>
          </div>
          <div>
            <p className="font-bold text-accent">Pace</p>
          ...
          <div>
            ...
            <p className="text-muted-foreground">Offensive Rating minus Defensive Rating. Positive is better.</p>
          </div>
        </div>
      </Card>
    </div>
